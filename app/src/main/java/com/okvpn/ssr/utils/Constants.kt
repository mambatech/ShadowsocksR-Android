...
object Constants
{
	...
	object Action
	{
		const val SERVICE = "com.okvpn.ssr.SERVICE"
		const val CLOSE = "com.okvpn.ssr.CLOSE"
		const val QUICK_SWITCH = "com.okvpn.ssr.QUICK_SWITCH"
		const val SCAN = "com.okvpn.ssr.intent.action.SCAN"
		const val SORT = "com.okvpn.ssr.intent.action.SORT"
	}
